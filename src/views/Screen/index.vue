  ...
  <div class="container">
    ...
    <container :options="{ width: 3840, height: 2160 }" v-else>
      ...
      <div class="center">
        <div class="left">
          <div class="left1">
            <total-user :today-user="userData.userToday" :growth-last-day="+userData.userGrowthLastDay || 0"
              :growth-last-month="+userData.userGrowthLastMonth || 0" ref="totalUser" />
          </div>
          <div class="left2">
          ...
          <div class="right-bottom">
            <div class="right-left">
              ...
              <div class="right-left2">
                <country-category :data="['订单量', '销售额', '用户数', '退单量']"
